...
const servicesInfo = [
  {
    ...
    fullDescription: [
      ...
      ' Además, nos especializamos en estudios bioclimáticos, lo que significa que diseñamos edificios teniendo en cuenta las características climáticas y ambientales de su ubicación. Mediante el análisis de la orientación solar, la ventilación natural, el uso eficiente de la energía y otros aspectos, creamos espacios que maximizan la comodidad de los ocupantes y minimizan el impacto ambiental.',
    ],
  },
  {
    id: 2,
    ...
    fullDescription: [
      ...
      'Nuestros modelos BIM son desarrollados con un nivel de detalle alto llegando en algunos casos a LOD 500 (Level of Development), lo que significa que ofrecemos un nivel de detalle muy alto en la representación de los elementos estructurales. Esto nos permite proporcionar información precisa y completa sobre la geometría, las propiedades materiales y las conexiones de cada componente estructural. Con el LOD 500, nuestros clientes pueden tomar decisiones informadas y anticipar con precisión el rendimiento y la construcción de sus proyectos.',
    ],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    image: image4,
    imageLow: image4Low,
    subheading: 'Dirección de obras',
    text: 'Nuestro servicio de dirección de obras de construcción es una solución integral y confiable para garantizar el éxito de cualquier proyecto',
    fullDescription: [
      'En asociación con nuestra filial Beltrán Construction, entendemos que la dirección de obras es fundamental para llevar a cabo proyectos de construcción de manera eficiente y efectiva.',
      'Nuestro equipo se encarga de supervisar y coordinar todos los aspectos de la obra, desde el inicio hasta la finalización. Su experiencia abarca desde pequeñas remodelaciones hasta proyectos de gran envergadura, lo que les permite adaptarse a cualquier desafío que se les presente.',
      'Nos enorgullece decir que nuestra empresa se destaca por su enfoque personalizado. Nos tomamos el tiempo para comprender las necesidades y objetivos específicos de cada cliente, y trabajamos en estrecha colaboración con ellos para garantizar que se cumplan todas sus expectativas. La comunicación fluida y constante es un pilar fundamental de nuestro servicio, y nos aseguramos de que nuestros clientes estén informados en todo momento sobre el progreso de la obra.',
    ],
  },
];
